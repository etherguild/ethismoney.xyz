...
export default function Page() {
  ...
  return (
    <div className="flex flex-col -space-y-[72px]">
      <SnapSection height={751}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
            <LandingContainerChild
              className="px-[15px] desktop:px-0 justify-center flex-1"
              height={469}
            >
              <div className="h-[405px] pb-2.5 flex-col justify-end items-start gap-[30px] inline-flex">
                ...
                <div className="self-stretch rounded-[999px] justify-start items-center gap-2.5 inline-flex">
                  <div className="h-[36px] px-[15px] rounded-full border border-blue2 justify-center items-center flex cursor-pointer">
            ...
            <LandingContainerChild
              ...
              height={469}
            >
              <div className="relative grow shrink basis-0 h-[469px] pt-[278px] flex-col justify-end items-center inline-flex">
                <div className="self-stretch h-[123px] flex-col justify-start items-center gap-[25px] flex">
                  ...
                  <div className="px-[15px] py-2.5 bg-blue5 rounded-[999px] justify-center items-center gap-2.5 inline-flex">
      ...
      <SnapSection height={702}>
        <div className="bg-blue-900/20 w-full h-full">
          <h2 className="headline-xl !leading-[41px] desktop:headline-xxl desktop:!leading-[68px] pb-[15px]">
            ETH is Money in the Ethereum economy
          </h2>
          <div className="pb-[15px]">ETH is exported to other chains and used as a high quality liquid asset (HQLA) for DeFi.</div>
          <EthExportProvider>
            <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
      ...
      <SnapSection height={803}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
          </div>
        </div>
      </SnapSection>
      <SnapSection height={766}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
          </div>
        </div>
      </SnapSection>
      <SnapSection height={600}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
          </div>
        </div>
      </SnapSection>
      <SnapSection height={722}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
          </div>
        </div>
      </SnapSection>
      <SnapSection height={643}>
        <div className="bg-blue-900/20 w-full h-full">
          <div className="flex flex-col desktop:flex-row desktop:items-center gap-[30px] w-full">
          </div>
        </div>
...
const SnapSection = ({ children, height }: SnapSectionProps) => {
  const { scrollPosition } = useUIContext();

  return (
    <div
      className={`desktop:pb-[50px] desktop:pr-[50px] desktop:pl-[0px] ${scrollPosition < 100 ? "desktop:pt-[109px]" : "desktop:pt-[97px]"}`}
      style={{
